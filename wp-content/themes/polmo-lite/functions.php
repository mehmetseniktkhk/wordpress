	...
	add_theme_support(
		...
		array(
			array(
				...
				'slug'  => 'primary',
				'color' => jeweltheme_blog_hsl_hex( 'default' === get_theme_mod( 'colorscheme' ) ? 199 : get_theme_mod( 'colorscheme_primary_hue', 199 ), 100, 33 ),
			),
		)
	);
...
function jeweltheme_polmo_starter_content() {
	// Twenty Seventeen
...
add_action( 'after_setup_theme', 'jeweltheme_polmo_starter_content' );

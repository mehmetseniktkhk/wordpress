...
//Service 1
$jeweltheme_polmo_service_icon_1 = get_theme_mod('jeweltheme_polmo_service_icon_1',__('fa-android','polmo-lite'));
$jeweltheme_polmo_service_title_1 = get_theme_mod('jeweltheme_polmo_service_title_1',__('Android Apps Developement','polmo-lite'));
$jeweltheme_polmo_service_desc_1 = get_theme_mod('jeweltheme_polmo_service_desc_1',__('Atoms dimensions approximately determined with one fifty-millionth an inch in diameter.','polmo-lite'));


//Service 2
$jeweltheme_polmo_service_icon_2 = get_theme_mod('jeweltheme_polmo_service_icon_2',__('fa-html5','polmo-lite'));
$jeweltheme_polmo_service_title_2 = get_theme_mod('jeweltheme_polmo_service_title_2',__('HTML5 Modern Technology','polmo-lite'));
$jeweltheme_polmo_service_desc_2 = get_theme_mod('jeweltheme_polmo_service_desc_2',__('Continuity as distinguished from may be considering what would be visible by magnification.','polmo-lite'));


//Service 3
$jeweltheme_polmo_service_icon_3 = get_theme_mod('jeweltheme_polmo_service_icon_3',__('fa-maxcdn','polmo-lite'));
$jeweltheme_polmo_service_title_3 = get_theme_mod('jeweltheme_polmo_service_title_3',__('Latest Max CDN Service','polmo-lite'));
$jeweltheme_polmo_service_desc_3 = get_theme_mod('jeweltheme_polmo_service_desc_3',__('Definite amount of matter in visible universe, a number of molecules and atoms in huge number.','polmo-lite'));


//Service 4
$jeweltheme_polmo_service_icon_4 = get_theme_mod('jeweltheme_polmo_service_icon_4',__('fa-umbrella','polmo-lite'));
$jeweltheme_polmo_service_title_4 = get_theme_mod('jeweltheme_polmo_service_title_4',__('Latest Umbrella Server','polmo-lite'));
$jeweltheme_polmo_service_desc_4 = get_theme_mod('jeweltheme_polmo_service_desc_4',__('Phenomena of light and waves of all lengths are found in velocity of 186,000 miles in a second.','polmo-lite'));

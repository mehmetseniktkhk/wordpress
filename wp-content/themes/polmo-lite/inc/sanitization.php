 ...
 */
function jeweltheme_polmo_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function jeweltheme_polmo_sanitize_css( $css ) {
 ...
 */
function jeweltheme_polmo_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function jeweltheme_polmo_sanitize_email( $email, $setting ) {
 ...
 */
function jeweltheme_polmo_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function jeweltheme_polmo_sanitize_html( $html ) {
 ...
 */
function jeweltheme_polmo_sanitize_image( $image, $setting ) {
 ...
 */
function jeweltheme_polmo_sanitize_nohtml( $nohtml ) {
 ...
 */
function jeweltheme_polmo_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function jeweltheme_polmo_sanitize_number_range( $number, $setting ) {
 ...
 */
function jeweltheme_polmo_sanitize_select( $input, $setting ) {
 ...
 */
function jeweltheme_polmo_sanitize_url( $url ) {
...
function jeweltheme_polmo_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
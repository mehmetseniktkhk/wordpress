...
if ( class_exists( 'WP_Customize_Panel' ) ){
	...
	if ( class_exists( 'WP_Customize_Panel' ) ){
		...
		/* Slider Title 1 */
		$wp_customize->add_setting( 'jeweltheme_polmo_slider_title1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Welcome to <span>Polmo</span>','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_slider_desc1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('POLMO theme is absolute free for your personal or business use','polmo-lite')));
		...
		/* Button 1 */
		$wp_customize->add_setting( 'jeweltheme_polmo_slider_button1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Download Polmo','polmo-lite')));
		...
		/* Button URL 1 */
		$wp_customize->add_setting( 'jeweltheme_polmo_slider_button_url1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('http://jeweltheme.com/product/polmo-lite','polmo-lite')));
		...
		/* Slider Title 2 */
		$wp_customize->add_setting( 'jeweltheme_polmo_slider_title2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Premium <span>Quality WordPress</span> Theme','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_slider_desc2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('POLMO is a Premium Wordpress html5 Template with clean, modern and unique styles','polmo-lite')));
		...
		/* Button 2 */
		$wp_customize->add_setting( 'jeweltheme_polmo_slider_button2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Download Polmo','polmo-lite')));
		...
		/* Button URL 2 */
		$wp_customize->add_setting( 'jeweltheme_polmo_slider_button_url2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('http://jeweltheme.com/product/polmo-lite','polmo-lite')));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ){
		...
		/* Service Title */
		$wp_customize->add_setting( 'jeweltheme_polmo_service_heading_title', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('<span>Polmo</span> Core Services','polmo-lite')));
		...
		/* Service Description */
		$wp_customize->add_setting( 'jeweltheme_polmo_service_desc', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Matter is made up of atoms having dimensions approximately determined to be in the neighbourhood of the one fifty-millionth of an inch in diameter.','polmo-lite')));
		...
		/* Service 1 Icon */
		$wp_customize->add_setting( 'jeweltheme_polmo_service_icon_1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('fa-android','polmo-lite')));
		...
		/* Service 1 Title */
		$wp_customize->add_setting( 'jeweltheme_polmo_service_title_1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Android Apps Developement','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_service_desc_1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Atoms dimensions approximately determined with one fifty-millionth an inch in diameter.','polmo-lite')));
		...
		/* Service 2 Icon */
		$wp_customize->add_setting( 'jeweltheme_polmo_service_icon_2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('fa-html5','polmo-lite')));
		...
		/* Service 2 Title */
		$wp_customize->add_setting( 'jeweltheme_polmo_service_title_2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('HTML5 Modern Technology','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_service_desc_2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Continuity as distinguished from may be considering what would be visible by magnification.','polmo-lite')));
		...
		/* Service 3 Icon */
		$wp_customize->add_setting( 'jeweltheme_polmo_service_icon_3', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('fa-maxcdn','polmo-lite')));
		...
		/* Service 3 Title */
		$wp_customize->add_setting( 'jeweltheme_polmo_service_title_3', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Latest Max CDN Service','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_service_desc_3', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Definite amount of matter in visible universe, a number of molecules and atoms in huge number.','polmo-lite')));
		...
		/* Service 4 Icon */
		$wp_customize->add_setting( 'jeweltheme_polmo_service_icon_4', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('fa-umbrella','polmo-lite')));
		...
		/* Service 4 Title */
		$wp_customize->add_setting( 'jeweltheme_polmo_service_title_4', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Latest Umbrella Server','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_service_desc_4', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Phenomena of light and waves of all lengths are found in velocity of 186,000 miles in a second.','polmo-lite')));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ){
		...
		/* About Us Title */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_title', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('<span>We</span> are Polmo Limited Creative Web Agency','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_expertise_title', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('<span>Our</span> areas of expertise','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_progress_title_1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('WordPress Plugin Dev','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_progress_percantage_1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('89','polmo-lite')));
		...
		/* About Us Expertise Percantage Title */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_progress_title_2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Web Design','polmo-lite')));
		...
		/* About Us Expertise Percantage */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_progress_percantage_2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('70','polmo-lite')));
		...
		/* About Us Expertise Percantage Title */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_progress_title_3', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('PHP Programming','polmo-lite')));
		...
		/* About Us Expertise Percantage */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_progress_percantage_3', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('60','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_button_text', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Learn More','polmo-lite')));
		...
		/* About Us Button URL */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_button_url', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('#','polmo-lite')));
		...
		/* About Us Counter 1 */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_icon_1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('fa-heart-o','polmo-lite')));
		...
		/* About Us Counter */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_number_1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('8,236','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_text_1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Love Bites','polmo-lite')));
		...
		/* About Us Counter 1 */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_icon_2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('fa-wifi','polmo-lite')));
		...
		/* About Us Counter */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_number_2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('1,203','polmo-lite')));
		...
		/* About Us Counter Text*/
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_text_2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Wifi Zones','polmo-lite')));
		...
		/* About Us Counter 1 */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_icon_3', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('fa-map-marker','polmo-lite')));
		...
		/* About Us Counter */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_number_3', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('3,679','polmo-lite')));
		...
		/* About Us Counter Text*/
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_text_3', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Customer Centers','polmo-lite')));
		...
		/* About Us Counter 1 */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_icon_4', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('fa-cogs','polmo-lite')));
		...
		/* About Us Counter */
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_number_4', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('2,310','polmo-lite')));
		...
		/* About Us Counter Text*/
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_counter_text_4', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Mechanical Cogs','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_about_us_work_with_us_title', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('<span>Why</span> Work With Us','polmo-lite')));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ){
		...
		/* Subscribe Title */
		$wp_customize->add_setting( 'jeweltheme_polmo_subscriber_title', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Polmo WordPress Version Is Live!','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_subscriber_desc', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('To get Polmo WordPress version subscribe now. Polmo theme is ablolutely free for your business or personal use.','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_subscriber_button', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Subscribe Now','polmo-lite')));
		...
		/* Subscriber URL */
		$wp_customize->add_setting( 'jeweltheme_polmo_subscriber_url', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('http://jeweltheme.com/product/polmo-lite','polmo-lite')));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ){
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_portfolio_title', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('<span>Featured</span> Projects','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_portfolio_desc', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('Suppose then that such rings were produced in a medium without friction as the ether is believed to be, they would be permanent structures with a variety of properties.','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_portfolio_posts', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('8','polmo-lite')));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ){
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_sponsors_url_1', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('http://jeweltheme.com','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_sponsors_url_2', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('http://jeweltheme.com','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_sponsors_url_3', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('http://jeweltheme.com','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_sponsors_url_4', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('http://jeweltheme.com','polmo-lite')));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ){
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_testimonial_heading_category', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('','polmo-lite')));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ){
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_map_contact_heading', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('<span>Contact</span> With Us','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_map_contact_shortcode', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('[contact-form-7 id="1234" title="Contact form 1"]','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_map_contact_center', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('-37.817331, 144.955652','polmo-lite')));
		...
		$wp_customize->add_setting( 'jeweltheme_polmo_map_contact_lat_lang', array('sanitize_callback' => 'jeweltheme_polmo_sanitize_text','default' => __('23.709921, 90.407143','polmo-lite')));

...
function jeweltheme_polmo_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'jeweltheme_polmo_custom_header_args', array(
		...
		'admin-head-callback'    => 'jeweltheme_polmo_admin_header_style',
		'admin-preview-callback' => 'jeweltheme_polmo_admin_header_image',
	) ) );
}
add_action( 'after_setup_theme', 'jeweltheme_polmo_custom_header_setup' );

if ( ! function_exists( 'jeweltheme_polmo_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see jeweltheme_polmo_custom_header_setup().
 */
function jeweltheme_polmo_header_style() {
...
endif; // jeweltheme_polmo_header_style

if ( ! function_exists( 'jeweltheme_polmo_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see jeweltheme_polmo_custom_header_setup().
 */
function jeweltheme_polmo_admin_header_style() {
?>
	<style type="text/css">
...
endif; // jeweltheme_polmo_admin_header_style

if ( ! function_exists( 'jeweltheme_polmo_admin_header_image' ) ) :
/**
